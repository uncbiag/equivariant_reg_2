...
def make_net(dimension):
    unet = fpc.Equivariantize(fpc.SomeDownsampleNet(dimension=dimension))
...
if __name__ == "__main__":
    ...
    net = make_net(3)
    net.regis_net.load_state_dict(torch.load("results/frontloaded_layers_diff-1/network_weights_1800"))
