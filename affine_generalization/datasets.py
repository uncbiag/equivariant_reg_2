...
#maximum_images=1000
#datasets_.append(dataset.Dataset(input_shape, "abdomen8k", "/data/hastings/Abdomen8k/AbdomenAtlas/*/ct.nii.gz", maximum_images=maximum_images, cache_filename=cache_filename))
cache_filename="results/aligned_dataset-1/"
maximum_images=2000
...
datasets_ = []
datasets_.append(dataset.PairedDICOMDataset(input_shape, "DukeLivers", "/playpen-raid1/Data/DukeLivers/Segmentation/Segmentation/*/*/images/", maximum_images=maximum_images, match_regex=r"Segmentation/([0-9]+)/", cache_filename="results/aligned_livers"))
...
cache_filename="results/aligned_partt2/"
maximum_images=2000
...
class DiffusionDataset(dataset.Dataset):
